This application selects randomly an English word one after another, from the english_words.csv file. Then it shows the solution after a few seconds, which is the Hungarian equivalent of the word.
